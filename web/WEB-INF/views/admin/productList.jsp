<%@ page import="com.ShenHe.model.Product" %>
...
<section id="cart_items">
		...
		<h2 class="title text-center">Product <strong>List</strong></h2> 
					...
					<!-- loop_start -->
						...
						<%
							com.ShenHe.model.Product p= (com.ShenHe.model.Product) pageContext.findAttribute("p");
							int pid=p.getProductId();
							java.sql.Connection con= (java.sql.Connection) application.getAttribute("con");
							String catName=com.ShenHe.model.Category.findByCategoryId(con,pid);
						%>
							...
							<td class="">
							<a class="cart_quantity_delete" href="<%=basePath%>admin/productEdit?productId=${productId}" >
							<i class="fa fa-edit">Edit</i></a>&nbsp;
							<a class="cart_quantity_delete" href="<%=basePath%>admin/productDelete?productId=${productId}">
